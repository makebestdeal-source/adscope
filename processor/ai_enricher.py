...
업종 목록 (아래 중 정확히 하나 선택):
IT/통신, 가전/전자, 가구/인테리어, 게임, 건설/부동산, 교육, 금융/보험,
뷰티/화장품, 반려동물, 생활용품, 스포츠/아웃도어, 식품/음료,
엔터테인먼트, 여행/항공, 유통/이커머스, 자동차, 제약/헬스케어,
주류, 패션/의류, 공공기관, 기타

제품/서비스 카테고리 — 반드시 아래 소분류명 중 정확히 하나만 입력 (대분류명 절대 입력 금지):
- 가전/전자: TV, 냉장고, 세탁기, 에어컨, 공기청정기, 로봇청소기, 조리기구, 헤어드라이어, 오디오
- 모바일/IT: 스마트폰, 태블릿, 노트북, 데스크톱, 이어폰/헤드폰, 스마트워치, 주변기기
- 소프트웨어/SaaS: 업무툴, 클라우드, 보안솔루션, ERP, CRM, 디자인툴, 협업툴, AI서비스
- 게임: 모바일게임, PC게임, 콘솔게임, 게임플랫폼, e스포츠
- 뷰티/화장품: 스킨케어, 메이크업, 향수, 헤어케어, 남성화장품, 바디케어, 더마/의약외품
- 패션: 의류, 신발, 가방, 액세서리, 스포츠웨어, 시계, 주얼리
- 식품/음료: 간편식, 건강식품, 음료, 커피, 주류, 유제품, 간식/베이커리, 신선식품
- 금융서비스: 카드, 보험, 투자, 대출, 저축, 핀테크, 암호화폐
- 자동차: 승용차, SUV, 전기차, 중고차, 수입차, 렌터카, 부품/용품
- 여행/레저: 항공권, 호텔, 패키지여행, 렌터카, 레저/체험, 캠핑, 크루즈
- 교육: 어학, 자격증, 온라인강의, 학원, 코딩교육, 유아/초등교육, 입시/수능
- 생활서비스: 배달, 이사, 청소, 인테리어, 수리, 세탁, 정비
- 앱서비스: 배달앱, 커머스앱, 금융앱, 유틸리티앱, SNS, 헬스앱, 데이팅앱
- 엔터테인먼트: 영화, OTT, 음악, 공연, 웹툰, 방송/미디어, 스트리밍
- 건강/의료: 병원, 약국, 건강검진, 다이어트, 영양제, 의료기기, 피부과/성형
- 부동산: 아파트분양, 오피스텔, 전월세, 상가, 토지, 프롭테크, 부동산중개
- 유통/쇼핑: 종합몰, 전문몰, 중고거래, 직구, 오프라인매장, 홈쇼핑, 멤버십
- 통신/인터넷: 이동통신, 인터넷, IPTV, IoT, 알뜰폰, B2B통신
- 스포츠/아웃도어: 운동용품, 아웃도어의류, 헬스/피트니스, 골프, 자전거, 등산/캠핑
- 반려동물: 반려동물식품, 반려동물용품, 동물병원, 펫보험
- 공공/기관: 정부기관, 공공서비스, NGO/비영리, 지자체

예시: "product_category": "스킨케어" (O) / "product_category": "뷰티/화장품" (X)
